...
namespace ShadowClassLibrary
{
    ...
    public class ListViewColumnSorter : IComparer
    {
        ...
        {
            int compareResult;
            var obj1 = ((ListViewItem)x).SubItems[ColumnToSort].Text;
            var obj2 = ((ListViewItem)y).SubItems[ColumnToSort].Text;
            ...
            else if (IsNumeric(obj1) && IsNumeric(obj2))
            {
                //Compare as decimal
                decimal val1 = decimal.Parse(obj1);
                decimal val2 = decimal.Parse(obj2);
